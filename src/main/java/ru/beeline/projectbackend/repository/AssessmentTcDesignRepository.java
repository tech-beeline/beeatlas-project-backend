...
public interface AssessmentTcDesignRepository extends JpaRepository<AssessmentTcDesign, Integer> {

    @Query("""
            SELECT t.assessmentId, COUNT(t.id)
            FROM AssessmentTcDesign t
    ...
    List<AssessmentTcDesign> findByAssessmentId(Integer assessmentId);
}
